...
Below is the directory of all active technical specification documents for ASCEND:

| Document | Purpose & Scope | Status |
| :--- | :--- | :--- |
| **`ASCEND.md`** | Master Project Entry Point & Startup Workflow | 🟢 Active |
| **`GAME_DESIGN.md`** | Azure Cloud Realm World Map Strategy & 5 Zones | 🟢 Active |
...
| **`UI_UX_SPEC.md`** | Light-Mode Palette (`#F8FAF9`, `#F1F5F9`) & Typography | 🟢 Active |
| **`ASSET_MANIFEST.md`** | 32 Equipment Items, Vintage Herbs, Pills & 5 Base Models | 🟢 Active |
| **`CODEBASE_CLEANUP_GUIDE.md`**| Codebase Pruning Audit & Dead Code Guidelines | 🟢 Active |
| **`AI_PROMPT_GUIDE.md`** | Stylized Low-Poly 3D Generation Prompts | 🟢 Active |
